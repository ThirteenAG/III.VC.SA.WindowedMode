...
uint32_t HookDxCameraClearFixIIIJmp;
void __declspec(naked) HookDxCameraClearFixIII(void) {
	...
	_asm jmp HookDxCameraClearFixIIIJmp
}
...
void CDxHandler::SetupHooksIII(void)
{
	...
	injector::MakeJMP(0x5B8E97, HookDxCameraClearFixIII, true);
	HookDxCameraClearFixIIIJmp = 0x5B8E9E;
